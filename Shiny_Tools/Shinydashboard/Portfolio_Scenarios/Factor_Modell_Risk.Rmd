...
```{r}
# RFinance2011factorModelRiskAnalysis.r
# Examples for R/Finance 2011 Factor Model risk tutorial
# author: Eric Zivot
...
# source in factorAnalytics functions. These are available for download at
# http://faculty.washington.edu/ezivot/ezresearch.htm Change loadPath to appropriate
# folder containing functions

loadpath = paste(getwd(),"/Tutorials/", sep="")
